...
```{r}
library("rtweet") #Uses an underlying package like httr and then builds specific functions for tweeter. If an API has a package great, if not (or if its bad package) then use httr. 
library("stringr")
library("tidyverse")
```
...
```{r}
authentication <- list(consumer_key = "OBrekVojgBvRKsEQbSq27zPX9",
                 consumer_secret = "ag2Id5t9xQmxmNVQzkXapub8qdpZZ1VGsqTZrIG8q5huRy1pXT",
                 access_token = "VfeKhjX1ilXc3tv4IzqWsJIa0L4NqWvu4oL0Msr",
                 access_token_secret = "Tnz0UxpqedJcQQxszxST4ZU91IfpDle0tI4hwIm1diMRx")
```
...
twitter_token <- create_token(app = "MY472_Gaby", 
